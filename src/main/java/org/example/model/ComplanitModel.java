...
public class ComplanitModel {
    ...
    public void getUserComplaints(UserDto user, HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            PreparedStatement pstm = connection.prepareStatement("SELECT c.CID, c.name, c.description, c.complain_date, c.status, c.resolved_date, c.resolved_time FROM complaint c JOIN user u ON c.user_id = u.UId");
